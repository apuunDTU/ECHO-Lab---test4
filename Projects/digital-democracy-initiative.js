...
const noteData = {
  ...
  preview: `<p>They can continue to provide the preview text as they currently do, and if you want to add multiple paragraphs, you can simply include HTML paragraph tags (<p>) in the preview text string.
For example, if you want to update a project's preview text to have multiple paragraphs, you can do it like this in the project data file.</p>
   
<p>They can continue to provide the preview text as they currently do, and if you want to add multiple paragraphs, you can simply include HTML paragraph tags (<p>) in the preview text string.
For example, if you want to update a project's preview text to have multiple paragraphs, you can do it like this in the project data file</p>`,
  researchTopics: [
    "Digital democracy",
